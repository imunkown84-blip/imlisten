  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <div className="text-center mb-8">
        <div className="inline-block bg-retro-accent text-white px-3 py-1 rounded border-2 border-retro-ink font-mono text-xs font-bold mb-3 shadow-retro-sm">
        ...
        <p className="text-stone-600 font-mono text-xs mt-1">Access your saved songs & analytics</p>
      </div>
